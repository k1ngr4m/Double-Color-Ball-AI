...
const SportsLotteryDataLoader = {
    historyPath: './data/sports_lottery_data.json',
    predictionsPath: './data/sport_lottery_ai_predictions.json',
    predictionsHistoryPath: './data/sport_lottery_predictions_history.json',
